  ...
  return (
    <nav className="fixed top-0 left-0 w-full backdrop-blur-md bg-white/10 border-b border-white/20 shadow-lg z-50">
      <div className="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center">
        <div className="text-2xl font-bold text-white tracking-wide cursor-pointer hover:text-purple-900 transition">
          BlogSite
        </div>

        <div className="hidden sm:flex items-center gap-6 text-white font-medium ml-auto">
